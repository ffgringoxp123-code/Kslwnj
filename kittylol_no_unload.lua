...
function Library.SendNotification(settings)
    ...
    AccentBar.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
setModuleInteractable(true)
    ...
    LockButton.MouseButton1Click:Connect(function()
        ...
        if ModuleManager._locked then
            ...
            ModuleName.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    WhiteGrad.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    HueStrip.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    return ColorpickerManager
            ...
            function ModuleManager:create_divider(settings: any)
                ...
                if settings and settings.showtopic then
                    local TextLabel = Instance.new('TextLabel')
                    TextLabel.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
                    TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0) -- 154, 182, 255
                ...
                if not settings or settings and not settings.disableline then
                    ...
                    Divider.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- White color
                    Divider.BorderSizePixel = 0
                    Divider.Name = 'Divider'
                    ...
                    Gradient.Color = ColorSequence.new({
                        ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 0, 0)),  -- Start with white
                        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 0, 0)), -- Keep it white in the middle
            ...
            function ModuleManager:create_dual_slider(settings: any)
                ...
                MinCircle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                MaxCircle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                CurrentOption.TextColor3 = Color3.fromRGB(0, 0, 0)
                ...
                CurrentOption.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function ModuleManager:create_feature(settings)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(20, 20, 20)
                    Checkbox.Text = ""
...
local av = main:create_tab('Avatar', 'rbxassetid://117218617893684')
        ...
        if System.__properties.__is_mobile then
            if value then
                if not System.__properties.__mobile_guis.triggerbot then
                    local triggerbot_mobile = create_mobile_button('Trigger', 0.7, Color3.fromRGB(0, 0, 0))
                    ...
                    triggerbot_mobile.button.InputEnded:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.Touch and not was_dragged then
                            ...
                            if System.__properties.__triggerbot_enabled then
                                ...
                                triggerbot_mobile.text.TextColor3 = Color3.fromRGB(0, 0, 0)
                            else
        ...
        if System.__properties.__is_mobile then
            if state then
                if not System.__properties.__mobile_guis.manual_spam then
                    local manual_spam_mobile = create_mobile_button('Spam', 0.8, Color3.fromRGB(0, 0, 0))
                    ...
                    manual_spam_mobile.button.InputEnded:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.Touch and not manual_was_dragged then
                            ...
                            if System.__properties.__manual_spam_enabled then
                                ...
                                manual_spam_mobile.text.TextColor3 = Color3.fromRGB(0, 0, 0)
                            else
...
local ball_velocity = {
    __config = {
        ...
        colors = {
            ...
            accent_green = Color3.fromRGB(0, 0, 0),
            accent_orange = Color3.fromRGB(0, 0, 0),
